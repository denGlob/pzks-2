...
abstract class CustomTab(private val graph: mxGraph, val type: String = "Task") : JPanel() {
    ...
    init {
        ...
        graphComponent.graphControl.addMouseListener(object : MouseAdapter() {
            override fun mouseClicked(e: MouseEvent) {
                ...
                //add new cell
                    e.x < 30 && e.y < 30 -> {
                        val newCell = graph.createVertex(graphParent, null, -1,
                ...
                //update field's value
                    cell != null -> {
                        ...
                        val newFieldText = if (cell.isEdge) {
                            cell.value.toString()
                        } else (cell.value as String).split('/')[1]
